<%-- 
    ...
    Author     : Jacob Dale
--%>
<%@page import="org.solent.com528.project.impl.webclient.TimeSchedulerHandler"%>
...
<%
    ...
    TimeSchedulerHandler tsh = new TimeSchedulerHandler();
    PricingDetails pd = tsh.getPriceDetails();
    ...
    if(actionStr.equals("add"))
    {
        ...
        try
        {
            ...
            else if(peakHour != -1 && peakHour >= 0 && peakHour <= 24 )
            {
